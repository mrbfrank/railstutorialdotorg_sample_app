...
describe User do
  ...
  it { should respond_to(:microposts) }           # railstutorial.org Listing 10.9
  it { should respond_to(:feed) }                 # railstutorial.org Listing 10.38
...
# Password validation  
  ...
  # Test for valid remember session token
  ...
  describe "micropost associations" do
    ...
    # railstutorial.org Listing 10.38
    describe "status" do
